...
export class ApprovalResolverBase {
  ...
  async createApproval(
    ...
    return await this.service.createApproval({
      ...
      data: {
        ...
        vacationRequest: args.data.vacationRequest
          ? {
              connect: args.data.vacationRequest,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => VacationRequest, {
    nullable: true,
  ...
  async getVacationRequest(
    ...
    const result = await this.service.getVacationRequest(parent.id);
