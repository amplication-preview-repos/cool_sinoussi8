...
@InputType()
class ApprovalUpdateManyWithoutVacationRequestsInput {
...
export { ApprovalUpdateManyWithoutVacationRequestsInput as ApprovalUpdateManyWithoutVacationRequestsInput };
